  ...
  "quad-laser-hair-removal": {
    ...
    options: [
      ...
      // Men's Laser Options
      {
        ...
        price: "£70 (6 for £350)",
        description: "Laser hair removal for shaping the beard line on cheeks",
      },
      {
        id: "beard-full",
        name: "Beard (Full)",
...
export const getActiveTreatment = (pathname) => {
  if (pathname.includes("/packages/profusion") || pathname === "/packages/profusion") {
