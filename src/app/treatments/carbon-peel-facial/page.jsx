...
export default function CarbonPeelSection() {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                A highly effective laser treatment that targets acne, enlarged pores, and oily skin, known as the "Hollywood Peel" for its immediate glowing results with no downtime.
              </p>
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  src="/skin_care/carbon-peel-vertical.jpg"
                  alt="Carbon Peel Facial treatment"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              This advanced laser procedure applies a layer of liquid carbon to the skin, which penetrates deep into the pores. A Q-Switch or Pico laser is then used to blast away the carbon, taking dead skin cells, oil, and impurities with it. The thermal effect also stimulates collagen production.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-medium">Deep Cleansing</span> reduces pore size, oiliness, and blackheads
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Skin Rejuvenation</span> stimulates collagen for firmer, plumper skin
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Zero Downtime</span> get immediate radiance ("Hollywood glow") with no peeling
                </li>
              </ul>
            </div>
      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/skin_care/carbon-peel-horizontal.jpg"
              alt="Carbon Peel results"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-4">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
              About the Carbon Peel
            </h3>
            <p className="text-gray-600 text-lg leading-relaxed">
              An incredibly popular pre-event skin boost.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Comfortable, warm laser sensation</li>
              <li>• Ideal for oily or acne-prone skin</li>
              <li>• Immediate "Hollywood Glow"</li>
            </ul>
          </div>
        </div>
      </section>
