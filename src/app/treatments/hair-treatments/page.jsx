          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Combat hair thinning and loss with our targeted Meso Hair, Dutexone, and PRP treatments, designed to nourish follicles and stimulate dense, healthy growth.
              </p>
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  src="/skin_care/hair-treatments-vertical.jpg"
                  alt="Specialized Hair Treatments"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Our Hair Restoration Therapies
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              We offer multiple tailored approaches to tackling hair loss. Depending on the underlying cause—be it genetics, stress, or age—our medical team will deploy advanced formulas to stop hair shedding and dramatically improve scalp health.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-medium">Meso Hair</span> – Direct injection of vitamins and peptides into the scalp
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Dutexone</span> – Powerful topical inhibitor to block DHT formulation in the follicle
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">PRP (Platelet-Rich Plasma)</span> – Harnessing your body's own growth factors for intense restoration
                </li>
              </ul>
            </div>
      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/skin_care/hair-treatments-horizontal.jpg"
              alt="Hair Treatments results"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Achieve longer-lasting, visibly thicker results.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Courses typically structured as 4 sessions</li>
              <li>• Performed by specialized clinicians</li>
              <li>• Natural-looking, science-backed thickness</li>
            </ul>
          </div>
        </div>
      </section>
              ...
              <div className="border border-gray-200 p-6 bg-white shadow-[3px_3px_6px_rgba(0,0,0,0.15)]">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-700">Meso Hair (4 Sessions):</span>
                    <span className="text-lg font-bold text-gray-900">
                      £400
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-700">Dutexone (4 Sessions):</span>
                    <span className="text-lg font-bold text-gray-900">
                      £500
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-700">PRP (4 Sessions):</span>
                    <span className="text-lg font-bold text-gray-900">
                      £400
                    </span>
                  </div>
