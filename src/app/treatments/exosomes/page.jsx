          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Cutting-edge regenerative therapy utilizing powerful signaling molecules to profoundly restore aging skin or stimulate dormant hair follicles.
              </p>
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  src="/skin_care/exosomes-vertical.jpg"
                  alt="Exosomes Face and Hair treatment"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Exosomes are the future of regenerative medicine. They are incredibly potent nanoparticles derived from stem cells that carry billions of communicative signals. When applied to the scalp or skin, they instruct tired cells to repair themselves, heavily boosting collagen production and accelerating tissue regeneration.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-medium">Skin Rejuvenation</span> drastically increases collagen and elastin
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Hair Restoration</span> reactivates dormant hair follicles and thickens hair
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Faster Healing</span> significantly reduces downtime from other procedures
                </li>
              </ul>
            </div>
      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/skin_care/exosomes-horizontal.jpg"
              alt="Exosomes Face and Hair results"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-4">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
              About Exosomes Therapy
            </h3>
            <p className="text-gray-600 text-lg leading-relaxed">
              Experience the pinnacle of cellular rejuvenation.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Can be microneedled or injected</li>
              <li>• Suitable for face, neck, and scalp</li>
              <li>• Outstanding results for hair loss and skin aging</li>
            </ul>
          </div>
        </div>
      </section>
