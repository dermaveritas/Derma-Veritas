...
export default function ChemicalPeelSection() {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Medical grade chemical peels designed to deeply exfoliate, 
                clear blemishes, and reveal a brighter, smoother, more youthful complexion.
              </p>
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  src="/skin_care/chemical-peel-vertical.jpg"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Our medical-grade chemical peels use customized clinical solutions to safely exfoliate the top layers of skin. They stimulate intense cellular turnover, leaving your skin refreshed, even-toned, and radiant. Perfect for managing acne, pigmentation, and fine lines.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-medium">Reduces Acne</span> and unclogs congested pores
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Fades Pigmentation</span> such as sun damage and age spots
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="font-medium">Smooths Texture</span> for a brighter, glowing complexion
                </li>
              </ul>
            </div>
      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/skin_care/chemical-peel-horizontal.jpg"
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Reveal your best skin with our expertly formulated medical peels.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Safe for various skin types</li>
              <li>• Minimal to moderate downtime</li>
              <li>• Courses recommended for severe pigmentation or acne</li>
            </ul>
          </div>
        </div>
      </section>
