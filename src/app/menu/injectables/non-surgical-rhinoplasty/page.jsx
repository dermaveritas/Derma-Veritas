          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  src="/injectables/Non-Surgical R-plasty veritcal.jpg"
      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/injectables/Non Surgiacal R-Plasty Horizental.jpg"
              alt="Non-surgical rhinoplasty results"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Precise hyaluronic acid filler placement to refine nose shape
              without surgery.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Immediate reshaping and refinement</li>
