          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  src="/injectables/Profhilo Veritcal.jpg"
      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/injectables/Profhilo Horizental.jpg"
              alt="Profhilo results"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Ultra-pure HA remodels skin quality for hydration, firmness, and
              glow using the BAP technique.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Results in 2–4 weeks; best after 2–3 sessions</li>
